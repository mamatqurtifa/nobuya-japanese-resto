...
import { IoRestaurantOutline, IoTimeOutline, IoStarOutline, IoLeafOutline, IoImageOutline, IoChevronDown, IoChevronUp } from 'react-icons/io5';
  ...
  const timeline = [
    {
      year: "2022",
      title: "The Beginning",
      description: "Nobuya Resto opened its doors in Jakarta, introducing authentic Kyoto cuisine with a modern twist."
    },
    {
      year: "2023",
      title: "Expansion",
      description: "Following our success, we opened our second branch in Surabaya to share our culinary vision with more of Indonesia."
    },
    {
      year: "2024",
      title: "Menu Evolution",
      description: "Introduced our signature Omakase experience and expanded our premium sake collection."
    },
    {
      year: "2025",
      title: "Looking Forward",
      description: "Continuing our journey of culinary excellence with plans for special chef collaborations and unique dining experiences."
    }
  ];
  ...
  return (
    <section id="about" className="section-padding bg-jp-cream relative overflow-hidden">
      ...
      <div className="container-custom">
        ...
        >
          <span className="text-warm-gold font-medium mb-2 inline-block">Our Story</span>
          <h2 className="font-heading text-3xl md:text-5xl mb-4">Discover Nobuya</h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 mb-20">
          ...
          >
            ...
            <p className="mb-4 text-lg leading-relaxed">
              Nobuya Resto embodies the concept of modern Japanese dining with warm and elegant touches of traditional Kyoto. As guests enter the restaurant, they are welcomed by a miniature torii gate in aged wood, symbolizing the transition into an authentic Japanese culinary experience.
            </p>
            
            <p className="mb-6 leading-relaxed">
              The restaurant's interior is dominated by neutral colors such as natural cream, light oak wood, and matte black accents, with touches of burgundy and matte gold in select ornaments to convey a premium yet serene ambiance.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="bg-pure-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="text-sm leading-relaxed">True flavors preserved as in Kyoto, with techniques passed down through generations</p>
              </div>
              <div className="bg-pure-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                <h4 className="font-heading text-xl mb-2 flex items-center">
                  <span className="text-warm-gold mr-2">
                ...
                <p className="text-sm leading-relaxed">Highest quality ingredients for every dish, sourced locally and from Japan</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          >
            ...
            >
              <h3 className="font-heading text-2xl flex items-center">
        ...
        >
          <div className="inline-block bg-ink-black text-white p-8 rounded-lg">
            <h3 className="font-heading text-2xl mb-4">Experience the Nobuya Difference</h3>
            <p className="mb-6 max-w-2xl mx-auto">
              We invite you to join us and experience the perfect harmony of tradition and innovation that makes Nobuya Resto unique.
            </p>
            <a href="/reservation" className="inline-block bg-warm-gold hover:bg-warm-gold/90 text-white px-8 py-3 rounded-lg transition-colors">
              Reserve Your Table
            </a>
          </div>
        </motion.div>
